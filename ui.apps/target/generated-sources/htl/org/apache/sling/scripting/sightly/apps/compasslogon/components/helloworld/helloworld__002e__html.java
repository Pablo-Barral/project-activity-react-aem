 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.compasslogon.components.helloworld;
...
out.write("\r\n    ");
_global_model = renderContext.call("use", com.compasslogon.core.models.HelloWorldModel.class.getName(), obj());
{
